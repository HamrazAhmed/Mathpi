...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh] md:min-h-[300vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50 overflow-hidden"
    >
      ...
      >
        {title || (
          <span>
            MathPi Dashboard with AI to guide, and you can Mentoring Session  <br /> from professionals.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[39rem] bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="h-96 w-[39rem] absolute inset-0 bg-[#010101] rounded-2xl p-2"
      >
        ...
        <Image
          ...
          alt="aceternity logo"
          fill
          className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-auto"
        />
      </motion.div>
    </div>
  );
